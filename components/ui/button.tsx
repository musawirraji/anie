  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        aniestyle: "bg-gradient-to-r from-blue-800 to-cyan-400 text-white px-6 py-3 rounded-md font-semibold shadow-md hover:opacity-90 transition duration-200",
        long: "w-full bg-white border border-gray-300 rounded-xl flex items-center px-6 py-4 shadow-md hover:shadow-lg transition duration-200 text-blue-800 font-semibold text-lg [&_svg]:mr-2",
      },
      size: {
